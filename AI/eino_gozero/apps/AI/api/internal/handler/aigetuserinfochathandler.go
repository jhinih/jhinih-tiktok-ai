...
func AIGetUserInfoChatHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewAIGetUserInfoChatLogic(r.Context(), svcCtx)
		resp, err := l.AIGetUserInfoChat(&req)
